...
class SearchProductListScreen extends StatefulWidget {
  @override
  _SearchProductListScreenState createState() => _SearchProductListScreenState();
}
...
class _SearchProductListScreenState extends State<SearchProductListScreen> {
  ...
  Widget popularProducts(){
    var pProvider = Provider.of<ProductsProvider>(context, listen: true).allSearchProducts;
    return Expanded(
      //width: Get.width,
  ...
  Widget mainContainer(){
    return Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Provider.of<ProductsProvider>(context, listen: true).allSearchProducts.length > 0 ?popularProducts() : Center(
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Search result", overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.black, fontSize: 12, fontFamily: 'PoppinsSemiBold')),
